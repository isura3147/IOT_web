...
import videoSrc from '../../assets/contact.back.mp4';
            ...
            <div className="col-lg-6 mb-4">
              <div className="contact-us-content text-white">
                ...
                <ul className="list-unstyled">
                  ...
                  <li>
                    <img className="img-class"src={phone_icon} alt="phone icon" /> +(94) 77737118
                  </li>
                  <li>
                    <img className="img-class" src={location_icon} alt="location icon" /> 298A, Borella Road, Habarakada, Homagama
                  </li>
                </ul>
              </div>
            </div>
